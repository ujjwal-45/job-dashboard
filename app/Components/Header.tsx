export default function Header() {
    return (
        ...
        <nav className="flex justify-between w-full max-md:flex-wrap max-md:max-w-full">
          <div className="flex items-center justify-center px-5 py-1 text-sm text-[#DC4A2D] font-medium whitespace-nowrap bg-neutral-200 max-md:px-3">
            Logo
          </div>
          <div className="flex flex-col justify-center my-auto text-md font-medium whitespace-nowrap text-zinc-400 max-md:max-w-full">
